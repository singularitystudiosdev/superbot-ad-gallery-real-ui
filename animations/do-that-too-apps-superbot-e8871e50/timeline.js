...
// do-that-too-apps: the do-that-too cold open up to the landed hub, then the hub's four-request chat
// (scenes/tabs-assets/chat.js: Gemini, Cursor, DoorDash, superbot), the workspace card and the end card
const SEQUENCE = [
  ['card', 'agents'], ['scene', 'tabs'],
  ['card', 'workspace'],
  ['end', 'end'],
];
