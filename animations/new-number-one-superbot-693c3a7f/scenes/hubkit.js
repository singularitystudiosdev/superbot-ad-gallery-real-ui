...
export const AGENTS = {
  ...
  // the agent scene 'arrive' adds to the rail mid-story: its mark is the real tbs-ic-windsurf symbol, so nothing is drawn
  windsurf: { name: 'Windsurf', mark: icon('windsurf'), tile: icon('windsurf'), ph: 'Ask Windsurf anything' },
};
