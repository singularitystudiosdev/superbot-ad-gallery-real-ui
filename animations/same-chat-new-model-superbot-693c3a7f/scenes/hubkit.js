...
export const AGENTS = {
  ...
  // the model this spot is about: the same provider as ChatGPT, a newer model, its own palette (.v-gpt6)
  gpt6: { name: 'GPT-6', mark: icon('openai'), tile: icon('openai'), ph: 'Ask GPT-6 anything' },
};
