// Claude Haiku 4.5, quick errand: tendies on DoorDash. Three tool chips land (open, pick, check out), the order card
// rises, and the gradient order pill resolves "Placing order..." into "Ordered!" with the arrival time. Card photo:
// img/tenders.jpg = "Chicken tenders and french fries - June 2023 - Sarah Stierch.jpg" by Missvain, Wikimedia
// Commons, CC BY 4.0. "Golden Tender Co." is made up.
import { lerp, seg, outCubic, outBack, streamCount } from '../../../lib.js';

const SAY = 'Earned it. Tendies are on the way.';
const CHIPS = [
  ['Opening DoorDash', 'Opened DoorDash'],
  ['Finding the best-rated chicken tenders near you', 'Picked Golden Tender Co.'],
...
export default {
  ...
  build(k, x) {
    ...
    const photo = x.img('tenders.jpg');
    const card = x.el(`<div class="dd-card">
      <div class="dd-head"><img class="dd-logo" src="${x.brand('doordash-logo.svg')}" alt="DoorDash"/><b>DoorDash order</b><span class="dd-tag">2 items</span></div>
      <div class="dd-photo"><img src="${photo}" alt="Chicken tenders"/><span class="dd-place"><b>Golden Tender Co.</b><i>${STAR}4.8</i><em>0.6 mi</em></span></div>
      <div class="dd-item"><span class="dd-thumb" style="background-image:url('${photo}')"></span><span class="dd-meta"><b>Chicken Tenders</b><small>Honey mustard, fries</small></span><span class="dd-qty">2x</span><span class="dd-price">$17.98</span></div>
      <div class="dd-fees">
        <div><span>Delivery fee</span><span>$1.99</span></div>
        <div><span>Service fee</span><span>$1.62</span></div>
        <div><span>Dasher tip</span><span>$3.00</span></div>
        <div class="dd-total"><span>Total</span><span>$24.59</span></div>
      </div>
      <div class="dd-addr"><span class="dd-pin">${PIN}</span><span class="dd-where"><b>Deliver to 1480 Market St, Apt 5</b><small>Visa ending 4242</small></span><span class="dd-eta"><span class="dd-eta-a">${CLOCK}7:42 PM</span></span></div>
      <div class="dd-btn">
      ...
      <div class="dd-etaline">${CLOCK}<span>Arriving at <b>7:42 PM</b>, your Dasher is on the way</span></div>
    </div>`);
