...
const more = [
  ...
  ['waffles-delivery-superbot-87a583a1', 'waffles-delivery-superbot-87a583a1/', 'order me waffles? ChatGPT says "I can\'t do that!"; superbot pops in, orders Denny\'s through DoorDash, and the real doorstep handoff plays with the superbot mascot riding the courier\'s shoulder (22.2s loop)', 'Ad spots'],
  ['waffles-website-superbot-87a583a1', 'waffles-website-superbot-87a583a1/', 'make me a website where people can rate waffle pics? ChatGPT hands back a code block and a list of chores; superbot builds it, the real rate-waffle-pics site runs in its preview, and the camera pushes into the real Publish button: "Live in one click." (24.5s loop)', 'Ad spots'],
