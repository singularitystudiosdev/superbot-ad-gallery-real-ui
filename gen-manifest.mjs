...
const more = [
  ...
  // the do-that-too cold open and end card, with the five demo scenes replaced by one chat: four errands
  // handled back to back in a single superbot window (Gemini, Cursor, DoorDash, superbot itself); 2026-09-24
  ['all-in-one-superbot-7c8f2a41', 'all-in-one-superbot-7c8f2a41/', 'four errands · one chat', 'Ad spots'],
